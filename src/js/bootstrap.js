...
!(function (t, e) {
  ...
  const t = new Map(),
    ...
    r = t =>
      o(t) ? (t.jquery ? t[0] : t) : "string" == typeof t && t.length > 0 ? document.querySelector(n(t)) : null,
    a = t => {
  ...
  function Fe(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (("body" !== Ht(e) || Ae(a)) &&
          (c = (n = e) !== $t(n) && Bt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : ye(n)),
  ...
  class ci extends W {
    ...
    static dataApiKeydownHandler(t) {
      ...
      const s = this.matches(Je)
          ? this
          : z.prev(this, Je)[0] || z.next(this, Je)[0] || z.findOne(Je, t.delegateTarget.parentNode),
